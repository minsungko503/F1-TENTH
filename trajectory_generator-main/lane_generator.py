...
def draw_lane(img, lane, color=(0, 0, 255), show_arrow=True):
    ...
    for idx in range(len(lane) - 1):
        cv2.line(img, tuple(lane[idx]), tuple(lane[idx + 1]), color, 1)
    ...
    if show_arrow:
        ...
        cv2.arrowedLine(img, tuple(start), tuple(end), (238, 130, 238), 1, tipLength=0.2)
...
if __name__ == "__main__":
    ...
    # Read map params
    yaml_file = "/home/patrick/trajectory_generator/f1tenth-racing-stack-ICRA22/maps/0218.yaml"
    ...
    # Read image
    img_path = "/home/patrick/trajectory_generator/f1tenth-racing-stack-ICRA22/maps/0218.png"
